...
import com.ppjj.cmmall.product.dao.BrandDao;
import com.ppjj.cmmall.product.dao.CategoryBrandRelationDao;
...
public class CategoryBrandRelationServiceImpl extends ServiceImpl<CategoryBrandRelationDao, CategoryBrandRelationEntity> implements CategoryBrandRelationService {
    ...
    @Override
    public void updateBrandByCatId(Long catId, String name) {
    ...
    @Override
    public void updateBrandByBrandId(Long brandId, String name) {
        CategoryBrandRelationEntity relationEntity = new CategoryBrandRelationEntity();
